...
## 셋째 결 — 류성룡(柳成龍, 1542~1607) 과 《징비록(懸毖錄)》
...
**첫째**, **안동의 옛 이름·일상·역사·예술을 한 글에 종합한 가장 풍성한 자리**. 황현탁 회원의 글은 — 단지 한 오페라 평이 아니라, **안동의 정체성의 결을 천 년 시간 전체로 풀어낸 결의 자리**. 古寧國부터 永嘉志까지, 안동국시·찜닭·노래에서 류성룡과 정비록·오페라까지 — 한 호흡으로 묶어낸 가장 풍성한 결.

**둘째**, **류성룡의 《징비록》 의 정신을 영가회 결로 옮겨 두신 자리**. 1600년 정계에서 물러난 류성룡 선생이 옥연정사(玉淵亭舍) 에서 집필한 — **"미리 경계하여 후환을 경계한다"** 는 《징비록》의 결. 그 결을 21세기 한 안동인이 한 오페라 관람을 통해 다시 결의 한 자리로 가져 두신 자리.

**셋째**, **김휘동 회원의 두 글**(`/archive/geul/geul-ungbu-eoneo`, `/archive/geul/geul-andong-brand`) **과 한 결로 호응**. 안동시장이셨던 김휘동 회원이 〈안동웅부·안동 브랜드 가치〉 의 결을 짚으셨다면, 황현탁 회원은 — **안동을 소재로 한 예술 작품과 오페라** 의 결로 한 자리. 두 결이 〈안동이 한국 정신문화의 수도〉 라는 한 자리의 결을 양 결로 받쳐 주는 자리.
