...
모임이 생기면 — **규칙이 따라온다**. 영가회는 — **1977년 3월 26일 창립과 동시에 회칙을 제정**했다. 글로 남기는 것 — 그것이 이 모임의 방식이었다.
...
— 회의 가장 깊은 한 줄. 〈친목과 상부상조〉 로 〈향토 발전〉 에 기여한다.

### 제4조·제5조 【회원】

회원에 관해서는 — 제4조와 제5조가 함께 다룬다. **안동 출신으로 서울 및 그 인근에 거주하는 인사로서 회원 2인 이상의 추천을 받아 입회**할 수 있다. **75세 이상의 회원은 준회원**이 된다. **회비를 2년 이상 납부하지 아니한 회원은 탈퇴한 것으로 간주**한다.

### 제7조 【임원】

**회장 1명, 부회장 10명 이내, 감사 2명**. 임원의 임기는 — **2년이며, 연임할 수 있다**. 회장이 궐위되면 — **부회장 중 최연장자가 직무를 대행**한다.

## 회칙의 구성

모임의 뼈대가 된 이 회칙은 — **네 개의 장, 열다섯 개의 조항**으로 이루어져 있다:
